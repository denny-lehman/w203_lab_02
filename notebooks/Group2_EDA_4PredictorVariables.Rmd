...
a <- ggplot(eda_data, aes(x = wind, y = logarea)) +
  geom_boxplot() +
  geom_smooth() +
  ggtitle("wind vs log(area)")

b <- ggplot(eda_data, aes(x = rain, y = logarea)) +
  geom_boxplot() +
  geom_smooth() +
  ggtitle("rain vs log(area)")

c <- ggplot(eda_data, aes(x = FFMC, y = logarea)) +
  geom_boxplot() +
  geom_smooth() +
...
scatterplotMatrix(~ logarea + wind + FFMC ,  data = eda_data,
